...
def to_ordinal(intx):
    a= str(intx)
    if a.endswith("1") and not a == "11":
        return "{0}st".format(intx)
    elif a.endswith("2") and not a == "12":
        return "{0}nd".format(intx)
    elif a.endswith("3") and not a == "13":
        return "{0}rd".format(intx)
    else:
        return "{0}th".format(intx)
